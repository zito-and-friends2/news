...
schedule.every().day.at("00:00").do(findF)
schedule.every().day.at("01:00").do(findF)
schedule.every().day.at("02:00").do(findF)
schedule.every().day.at("03:00").do(findF)
schedule.every().day.at("04:00").do(findF)
schedule.every().day.at("05:00").do(findF)
schedule.every().day.at("06:00").do(findF)
schedule.every().day.at("07:00").do(findF)
schedule.every().day.at("08:00").do(findF)
schedule.every().day.at("09:00").do(findF)
schedule.every().day.at("10:00").do(findF)
schedule.every().day.at("11:00").do(findF)
...
schedule.every().day.at("23:00").do(findF)
